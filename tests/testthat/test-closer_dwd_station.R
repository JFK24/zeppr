...
test_that("test closer_dwd_station()", {
  ...
  expect_equal("00433", closer_dwd_station(52.518611, 13.4083330, stations_table=my.stations))
  expect_equal("Berlin-Tempelhof", closer_dwd_station(52.518611, 13.4083330, stations_table=my.stations, return_string = "name"))
})
