...
(no time data is required here for the calculation). 
A growing degree-days value is calculated for each pair independently from 
the other pairs. 
...
An example ISIP hourly weather data file is provided with this package at the 
following path: 
