...
You can install the latest version of `zeppr` 
from [GitHub](https://github.com/) as follows:
...
We have corresponding weather data manually downloaded from the ISIP service
